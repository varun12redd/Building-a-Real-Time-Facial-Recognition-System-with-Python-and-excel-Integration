...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'vr657658@gmail.com' ")
...
message3 = tk.Label(window, text="GNIT Smart Attendance System" ,fg="#FFD700",bg="black" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="white",bg="black" ,width=55 ,height=1,font=('comic', 22, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="white",bg="black" ,width=55 ,height=1,font=('comic', 22, ' bold '))
clock.pack(fill='both',expand=1)
tick()

head2 = tk.Label(frame2, text="            For New Student Registrations                       ", fg="black",bg="yellow" ,font=('comic', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="            For Already Registered Students                      ", fg="black",bg="yellow" ,font=('comic', 17, ' bold ') )
head1.place(x=0,y=0)

lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="#000080"  ,bg="#c79cff" ,font=('comic', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter name",width=20  ,fg="Red"  ,bg="#c79cff" ,font=('comic', 17, ' bold '))
